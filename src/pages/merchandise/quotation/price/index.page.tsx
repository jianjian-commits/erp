      ...
      Cell: (cellProps) => (
        <OperationCell>
          <OperationDetail
            onClick={() =>
              history.push(
                `/merchandise/quotation/price/detail?id=${cellProps.original.rule_set_id}`,
              )
            }
          />
          <OperationDelete
    ...
    <>
      ...
      <BoxTable
        ...
        action={
          <Button
            type='primary'
            onClick={() => history.push('/merchandise/quotation/price/detail')}
          >
            {t('新建协议单')}
          </Button>
        }
