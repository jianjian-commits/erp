...
export interface StockInPriceTableProps extends HTMLAttributes<HTMLDivElement> {
  reference_price: GetSkuReferencePricesResponse_InStockReferencePrice[]
  targetUnitId: string
  skuId: string
}

const StockInPriceTable: FC<StockInPriceTableProps> = observer(
  ({ className, reference_price, targetUnitId, skuId, onClick }) => {
    const columns = [
      {
        title: '日期',
        dataIndex: 'time',
...
export default StockInPriceTable
