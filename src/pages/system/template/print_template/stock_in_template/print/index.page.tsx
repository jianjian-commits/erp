...
type ApiType = 'purchase_in'

const getRestfulApi = (type: ApiType) => {
  let apiFn
  switch (type) {
    case 'purchase_in':
      apiFn = ListPurchaseInStockSheet
      break
    default:
      // 兼容额外的入库单据
