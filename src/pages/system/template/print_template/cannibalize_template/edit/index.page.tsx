...
import { EditorStockOut, EditorCannibalize } from 'gm-x-printer'
import { Tip, LoadingChunk } from '@gm-pc/react'
import defaultConfig from '../config/template_config/cannibalize_config'
import mockData from '../config/mock_data/cannibalize_data.json'
...
const TemEditor = () => {
  ...
  if (loading) {
    ...
    return (
      <EditorCannibalize
        config={content}
        mockData={cannibalizeDataKey(mockData, {
          shelfList: ShelfData.shelves,
        })}
        onSave={handleSave}
        showEditor
        addFields={addFields}
